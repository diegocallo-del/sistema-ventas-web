  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Informacion de la Venta</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div className="flex items-center gap-3">
              <FileText className="w-5 h-5 text-secondary-500" />
              <div>
                <p className="text-sm text-secondary-600">Numero de Venta</p>
                <p className="font-semibold">#{venta.id.toString().padStart(6, '0')}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">{formatDate(venta.fecha, true)}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-secondary-600">Metodo de Pago</p>
                <p className="font-semibold capitalize">{venta.metodo_pago}</p>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <User className="w-5 h-5 text-secondary-500" />
              <div>
                <p className="text-sm text-secondary-600">Vendedor</p>
                {venta.usuario ? (
                  <p className="font-semibold">
                    {formatFullName(venta.usuario.nombre, venta.usuario.apellido)}
                  </p>
                ) : (
                  <p className="font-semibold">No especificado</p>
                )}
